package com.zongze.middleware.dynamic.thread.pool.sdk.config;


import com.zongze.middleware.dynamic.thread.pool.sdk.domain.DynamicThreadPoolService;
...
import com.zongze.middleware.dynamic.thread.pool.sdk.registry.redis.RedisRegistry;
import com.zongze.middleware.dynamic.thread.pool.sdk.trigger.job.ThreadPoolDataReportJob;
import com.zongze.middleware.dynamic.thread.pool.sdk.trigger.listener.ThreadPoolConfigAdjustListener;
...
public class DynamicThreadPoolAutoConfig {
    ...
    public DynamicThreadPoolService dynamicThreadPoolService(ApplicationContext applicationContext, Map<String, ThreadPoolExecutor> threadPoolExecutorMap,RedissonClient redissonClient){
        ...
        if(StringUtils.isBlank(applicationName)){
            applicationName="缺少的";
            logger.warn("动态线程池，启动提示。SpringBoot应用未配置spring.application.name 无法获得应用名称！");
        }
